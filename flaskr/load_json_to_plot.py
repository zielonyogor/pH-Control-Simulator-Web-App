...
def create_plot(acid, cp, cp_level, cp_type, given_pH, control_system):
    ...
    fig1.update_layout(title_font=dict(size=16, color='#F7F3E3'), paper_bgcolor="#1c7293", legend=dict(x=0.7, y=0.1, bgcolor='#F7F3E3'), showlegend=True)
    ...
    fig2.update_layout(title_font=dict(size=16, color='#F7F3E3'), paper_bgcolor="#1c7293", legend=dict(x=0.65, y=0.1, bgcolor='#F7F3E3'), showlegend=True)
    ...
    fig3.update_layout(title_font=dict(size=16, color='#F7F3E3'), paper_bgcolor="#1c7293", legend=dict(x=0.05, y=0.05, bgcolor='#F7F3E3'), showlegend=True)
