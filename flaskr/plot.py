...
def create_plot(acid):
    ...
    fig1 = px.scatter(x=t, y=h, labels={'x': acid.name, 'y': 'Y-axis'})
    fig2 = px.scatter(x=t, y=[Qd_acid, Qd_pollutant, Qo], labels={'x': acid.name, 'y': 'Y-axis'})
    fig3 = px.scatter(x=t, y=[u_pi, u], labels={'x': acid.name, 'y': 'Y-axis'})
    fig4 = px.scatter(x=t, y=[pH, pH_doc_list], labels={'x': acid.name, 'y': 'Y-axis'})
    fig5 = px.scatter(x=t, y=[c, c_doc_list], labels={'x': acid.name, 'y': 'Y-axis'})
